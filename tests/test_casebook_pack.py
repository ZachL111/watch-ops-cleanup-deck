"""Regression checks for the watch-ops-cleanup-deck casebook."""
...
from casebook.harness import assert_expected, watch_ops_cleanup_deck_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(watch_ops_cleanup_deck_summary(), assert_expected())
